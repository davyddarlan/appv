<template>
    <Question>
        ...
        <template v-slot:input>
            <radioQuestion v-model="model[0]" id="ventilacao-natural-mecanica"></radioQuestion>
        </template>
        <template v-slot:sub>
            <template v-if="model[0]">
                <div class="question">
                    <p class="statement">O ambiente possui exaustor</p>
                    <radioQuestion v-model="model[1]" id="exaustor"></radioQuestion>
                </div>
            </template>
        </template>
    </Question>
