<template>
    <Question>
        O acesso a este ambiente necessita de algum meio de circulação vertical (rampa, elevador, plataforma mecânica)
        <template v-slot:input>
            <radioQuestion v-model="model[0]" id="necessita-acessibilidade"></radioQuestion>
        </template>
        <template v-slot:sub>
            <template v-if="model[0]">
                <div class="question">
                    <p class="statement">Exite algum meio de circulação vertical no acesso a este ambiente: rampa, elevador e plataforma mecânica.</p>
                    <radioQuestion v-model="model[1]" id="tem-acessbilidade"></radioQuestion>
                </div>
            </template>
        </template>
    </Question>
