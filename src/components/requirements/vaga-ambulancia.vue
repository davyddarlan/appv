<template>
    <Question>
        Qual a quantidade de vagas para o estacionamento de ambulâncias
        <IonIcon v-if="isChecked" id="checkRequirements" :icon="checkmarkDoneSharp"></IonIcon>
        <template v-slot:input>
            <IonInput v-model="model" type="number" fill="outline" placeholder="Quantidade de vagas"></IonInput>
        </template>
    </Question>
</template>
